...
module.exports = function ( graphContainerSelector ){
  ...
  graph.removeNodeViaEditor = function ( node ){
    ...
    if ( removedItems > 2 ) {
      var text = "You are about to delete 1 class and " + propsToRemove.length + " edges";
      if ( datatypes !== 0 ) {
        text = "You are about to delete 1 class, " + datatypes + " datatypes  and " + propsToRemove.length + " edges";
      }
