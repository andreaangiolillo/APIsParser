...
module.exports = function ( graph ){
  ...
  function addAttribute( selectedElement, char ){
    ...
    if (getPresentAttribute(selectedElement, "service")) {
      selectedElement.styleClass("serviceColor");
      visAttr = selectedElement.visualAttributes();
      var visInd = visAttr.indexOf("service");
      if ( visInd > -1 ) {
